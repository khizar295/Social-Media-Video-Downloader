...
export default function Facebook() {
  ...
  const handleDownload = () => {
    ...
    const facebookRegex = /^https?:\/\/(www\.)?youtube\.com\/.+/;
  ...
  return (
    <div>
      <div className="fb-home bg-gray-900 flex flex-col justify-center min-h-screen">
        <button className="flex flex-col items-center mx-auto px-4 py-3 sm:px-6 sm:py-4 bg-red-600 text-white rounded-xl hover:bg-red-800 transition duration-300 font-bold w-32 sm:w-40">
      ...
      <div className="download mt-16 flex flex-col md:flex-row items-center md:items-start md:ms-37">
        <div className="text-center md:text-left">
          ...
          <p className="text-lg mt-8">
            Have you ever wanted to save a video from YouTube? Maybe you want
            ...
            you. YouTube Video <br /> Downloader is a simple and easy-to-use
            tool that lets you download your <br /> videos from YouTube. It's
            never been easier to save and share your favorite <br /> YouTube
            videos with friends, family, and anyone who loves them as much{" "}
            <br /> as you do. With our simple and easy-to-use tool, you can
            download all the <br /> videos you want from YouTube and save them
      ...
      <div className="min-h-[146px] px-4 how-download">
        <div className="bg-gray-900 w-full max-w-[980px] mx-auto rounded-3xl py-13 px-6 md:px-26">
          ...
          <p className="text-white text-base md:text-[1.1em] mt-1 leading-relaxed">
            Open the YouTube app or website, go to the photo, video, reels,
